                                ...
                                <div key={server.id} className={`bg-zinc-900 border rounded-xl p-6 ${server.status === 'AVAILABLE' ? 'border-brand-green/30' :
                                    ...
                                    <div className="flex items-center justify-between mb-4">
                                        <div>
                                            ...
                                            <p className="text-zinc-500 font-mono">{server.ip}:{server.port}</p>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                        <div>
                                            ...
                                            <span className="ml-2 text-white">{server.region}</span>
                                        </div>
                                        <div>
                                            <span className="text-zinc-500">Current Match:</span>
                                            <span className="ml-2 text-white">
                                                {server.currentMatch ? server.currentMatch.status : 'None'}
                                            </span>
                                        </div>
                                        <div>
                                            <span className="text-zinc-500">Password:</span>
                                            <span className="ml-2 text-white font-mono">{server.password || 'None'}</span>
                                        </div>
                                        <div>
